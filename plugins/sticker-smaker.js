...
if (!mime) throw '✳️ Responde ala imagen'
if (!/image\/(jpe?g|png)/.test(mime)) throw `✳️ Formato no soportable soy vaga`
...
m.reply('Error de conversión a pegatina, envíalo como imagen en su lugar')
