...
function pickRandom(list) {
 ...
 function ucapan() {
  ...
  let res = "𝙰𝚖𝚊𝚗𝚎𝚌𝚒𝚘 𝙱𝚒𝚎𝚗 𝙷𝚘𝚢?";
  if (time >= 4) {
    res = "𝙰 𝙲𝚊𝚜𝚒 𝚍𝚎 𝚖𝚎𝚍𝚒𝚘 𝚍𝚒𝚊 :𝟹 ☀️";
  }
  if (time >= 10) {
    res = "𝚈𝚊 𝚎𝚜 𝚎𝚜𝚝𝚊𝚖𝚘𝚜 𝚝𝚊𝚛𝚍𝚎 ☀️";
  }
  if (time >= 15) {
    res = "𝚈𝚊 𝚟𝚊 𝚜𝚎𝚛 𝚗𝚘𝚌𝚑𝚎 :𝟹 🌇";
  }
  if (time >= 18) {
    res = "𝙳𝚎𝚋𝚎𝚛𝚒𝚊 𝚒𝚛 𝚊 𝚍𝚘𝚛𝚖𝚒𝚛 𝚙𝚛𝚘𝚗𝚝𝚘 🌙";
  }
  return res;
}
