...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} Tu eres el ganador 🎉 *+${winScore} XP*` : isTie ? `Perdite el juego, con un empate *+${playScore} XP*` : `Ahora es tu turno ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`} 
...
Escribe *rendirse* para rendirte 
`.trim()
