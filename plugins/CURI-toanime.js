...
if (!/image/g.test(mime)) throw '*Responder a una imagen*'
m.reply('*Este comando puede convertir tu foto en anime.*')    
...
throw '*Error al comprobar si la cara de la persona es visible*'
}}}}
